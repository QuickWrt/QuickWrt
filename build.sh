...
prepare_source_code() {
    ...
    # 克隆源代码
    if git clone $git_url >/dev/null 2>&1 && cd openwrt && git -c advice.detachedHead=false checkout v$tag_version >/dev/null 2>&1 && git describe --abbrev=0 --tags > version.txt; then
        echo -e "  ${BOLD}${MAGENTA_COLOR}│${RESET}"
...
private_source_packaging() {
    ...
    if [ "$platform" = "x86_64" ]; then
        ...
        cp -a bin/packages/x86_64/base/*quectel*.ipk "$kmodpkg_name"/ 2>/dev/null || true
        ...
        cp -a bin/packages/aarch64_generic/base/*quectel*.ipk "$kmodpkg_name"/ 2>/dev/null || true
  ...
  "armsom,sige3": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-armsom_sige3-squashfs-sysupgrade.img.gz"
    }
  ],
  "armsom,sige7": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-armsom_sige7-squashfs-sysupgrade.img.gz"
    }
  ],
  "friendlyarm,nanopc-t4": [
    {
      "build_date": "$CURRENT_DATE",
      "sha256sum": "$SHA256_t4",
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopc-t4-squashfs-sysupgrade.img.gz"
    }
  ],
  "friendlyarm,nanopc-t6": [
    {
      "build_date": "$CURRENT_DATE",
      "sha256sum": "$SHA256_t6",
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopc-t6-squashfs-sysupgrade.img.gz"
    }
  ],
  "friendlyarm,nanopi-r2c-plus": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopi-r2c-plus-squashfs-sysupgrade.img.gz"
    }
  ],
  "friendlyarm,nanopi-r2c": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopi-r2c-squashfs-sysupgrade.img.gz"
    }
  ],
  "friendlyarm,nanopi-r2s": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img.gz"
    }
  ],
  "friendlyarm,nanopi-r3s": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopi-r3s-squashfs-sysupgrade.img.gz"
    }
  ],
  ...
  "friendlyarm,nanopi-r4se": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopi-r4se-squashfs-sysupgrade.img.gz"
    }
  ],
  ...
  "friendlyarm,nanopi-r6c": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopi-r6c-squashfs-sysupgrade.img.gz"
    }
  ],
  "friendlyarm,nanopi-r6s": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-friendlyarm_nanopi-r6s-squashfs-sysupgrade.img.gz"
    }
  ],
  ...
  "huake,guangmiao-g4c": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-huake_guangmiao-g4c-squashfs-sysupgrade.img.gz"
    }
  ],
  "lunzn,fastrhino-r66s": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-lunzn_fastrhino-r66s-squashfs-sysupgrade.img.gz"
    }
  ],
  "lunzn,fastrhino-r68s": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-lunzn_fastrhino-r68s-squashfs-sysupgrade.img.gz"
    }
  ],
  "radxa,rock-5a": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-radxa_rock-5a-squashfs-sysupgrade.img.gz"
    }
  ],
  "radxa,rock-5b": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-radxa_rock-5b-squashfs-sysupgrade.img.gz"
    }
  ],
  "xunlong,orangepi-5-plus": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-xunlong_orangepi-5-plus-squashfs-sysupgrade.img.gz"
    }
  ],
  "xunlong,orangepi-5": [
    {
      ...
      "url": "$OTA_URL/v$VERSION/openwrt-$VERSION-rockchip-armv8-xunlong_orangepi-5-squashfs-sysupgrade.img.gz"
    }
  ]
}
EOF
